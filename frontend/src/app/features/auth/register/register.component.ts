...
@Component({
          ...
          <form [formGroup]="registerForm" (ngSubmit)="register()" class="auth-form">
            ...
            <div class="form-group">
              ...
              <div class="input-wrapper">
                ...
                <input id="phone" type="tel" formControlName="phone" placeholder="Enter 10-digit phone number"/>
              </div>
  ...
  styles: [`
    ...
    .card-title { font-size: 26px; font-weight: 700; color: #0F172A; margin: 0 0 8px 0; }
